 ...
 *
 * @param {String} name Config's name: 'csscomb', 'zen', 'yandex', or 'alphabetize'
 * @returns {Object} Configuration object
 */
CSScomb.getConfig = function getConfig(name) {
    // Names of predefined configs:
    var CONFIGS = ['csscomb', 'zen', 'yandex', 'alphabetize'];
    name = name || 'csscomb';
    ...
    if (CONFIGS.indexOf(name) < 0) {
        throw new Error('"' + name + '" is not a valid config name. Try one of ' +
            'the following: \'csscomb\', \'zen\', \'yandex\' or \'alphabetize\'.');
    }
